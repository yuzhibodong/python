...
password = 'jhb5088794'
to_addr = '516585043@qq.com'
smtp_server = 'smtp.163.com'

# 邮件对象
msg = MIMEMultipart()
msg['From'] = _format_addr(u'一个爱着赵璐的小帅哥 <%s>' % from_addr)
# msg['To'] 接收的是字符串而不是list, 如果有多个地址 用,分隔即可
msg['To'] = _format_addr(u'老婆 <%s>' % to_addr)
msg['Subject'] = Header(u'老婆大人您好,果照请接收...', 'utf-8').encode()
